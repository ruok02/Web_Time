// appointment.js - user.html의 핵심 비즈니스 로직 (약속 관리 및 D-Day 계산)
...
/**
 * 다크 모드 전환 시 동적 요소들의 스타일을 업데이트합니다.
 */
...
window.onload = function () {
    ...
    // view-manager 초기화 (view-manager.js에 정의된 함수 호출)
    if (typeof initializeViewManager === 'function') {
